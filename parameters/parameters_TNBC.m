...
function params = parameters_TNBC(TumorArray,cancer_clones,n_T_specs)
...
for nc=1:ncancer_clones
    params.(['k_' cancer_clones{nc} '_growth']).Value = 0.0075;
...
for i=2:ntumors
    for nc=1:ncancer_clones
        params.(['k_' cancer_clones{nc} '_growth' TumorArray{i}]).Value = 0.0075;
