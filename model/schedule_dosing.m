...
% C1
addParameter(in,'C1_dose',4.7e6); 
addParameter(in,'C1_schedule',[200,0,1]);
...
parse(in,varargin{:});
% C1
dose_C1 = in.Results.C1_dose;
schedule_C1 = in.Results.C1_schedule;
...
% C1
doseObj_C1 = sbiodose('pembro','Amount',dose_C1,'AmountUnits','cell','TargetName','V_T_Ln1.C1');
doseObj_C1.StartTime = schedule_C1(1);
doseObj_C1.Interval = schedule_C1(2);
doseObj_C1.TimeUnits = 'day';
doseObj_C1.RepeatCount = schedule_C1(3);
doseObj_C1.Active = true;
